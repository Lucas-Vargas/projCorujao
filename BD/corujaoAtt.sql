...
--
-- Host: 127.0.0.1
-- Tempo de geração: 28-Nov-2023 às 02:23
...
INSERT INTO `times` (`idTime`, `NomeTime`, `idUsu`, `descTime`) VALUES
(1, 'Rensga', 3, 'Deus acima de tudo, Rensga acima de todos.'),
(2, 'Time Ruim', 3, 'Sou ruim'),
(123, 'asdasdasdasdas', 3, 'adasdasdasd');
...
CREATE TABLE `usuario` (
  ...
  `Times_idTime` int(11) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `usuario` (`idUsu`, `NomeUsu`, `SenhaUsu`, `EmailUsu`, `Times_idTime`) VALUES
(3, 'Coituss', '123', 'coitinho@gmail.com', 123);
...
--
ALTER TABLE `times`
  MODIFY `idTime` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=124;
...
--
ALTER TABLE `times`
  ADD CONSTRAINT `times_ibfk_1` FOREIGN KEY (`idUsu`) REFERENCES `usuario` (`idUsu`);
